...
const file_goods_proto_rawDesc = "" +
	...
	"\x04code\x18\x02 \x01(\x03R\x04code23\n" +
	"\x05Goods\x12*\n" +
	"\x05Login\x12\x0f.proto.LoginReq\x1a\x10.proto.LoginRespB\x04Z\x02./b\x06proto3"
...
var file_goods_proto_depIdxs = []int32{
	0, // 0: proto.Goods.Login:input_type -> proto.LoginReq
	1, // 1: proto.Goods.Login:output_type -> proto.LoginResp
